...
END_OF_BASH_PROFILE
  ...
  if [[ ${OSTYPE} =~ ^darwin ]]; then
    ...
    brew install --quiet --cask 1password 1password-cli nextcloud balenaetcher rectangle raycast firefox google-chrome postico cyberduck spotify discord obs slack iterm2 minio/stable/mc
